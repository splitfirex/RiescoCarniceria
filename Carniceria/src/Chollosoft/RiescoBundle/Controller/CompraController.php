...
class CompraController extends Controller {
	...
	public function createAction(Request $request) {
		...
		$carros = $em->getRepository ( 'CarniceriaBundle:Carro' )->findBy ( array (
				'usuarioSession' => $session->getId() 
		) );
	...
	private function createEditForm(Compra $entity) {
		$form = $this->createForm ( new CompraType (), $entity, array (
				'action' => $this->generateUrl ( 'compra_update', array (
						'id' => $entity->getId () 
				) ),
				'method' => 'PUT' 
		) );
	...
	public function updateAction(Request $request, $id) {
		...
		if ($editForm->isValid ()) {
			...
			return $this->redirect ( $this->generateUrl ( 'compra_edit', array (
					'id' => $id 
			) ) );
		}
	...
	private function createDeleteForm($id) {
		return $this->createFormBuilder ()->setAction ( $this->generateUrl ( 'compra_delete', array (
				'id' => $id 
